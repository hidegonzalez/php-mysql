...
<body>
    ...
    <input type ="submit" name="answer" value="繼續刪除課程">
    </form>
    <form action="newcourse.php" method="post">
    <input type ="submit" name="answer" value="繼續新增課程">
    </form>
    <form action="refrashcourse.php" method="post">
